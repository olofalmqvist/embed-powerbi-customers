...
namespace AppOwnsData.Services
{
    ...
    public class ConfigValidatorService
    {
        ...
        {
            string message = null;
            bool isAuthModeMasterUser = azureAd.Value.AuthenticationMode.Equals(AuthenticatorMode.MasterUser, StringComparison.InvariantCultureIgnoreCase);
            bool isAuthModeServicePrincipal = azureAd.Value.AuthenticationMode.Equals(AuthenticatorMode.ServicePrincipal, StringComparison.InvariantCultureIgnoreCase);
